...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Ma(){return new dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ds(),fragmentShader:`
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Sa(){return new dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ds(),fragmentShader:`
