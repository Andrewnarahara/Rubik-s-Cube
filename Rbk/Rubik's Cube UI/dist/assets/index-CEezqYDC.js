...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function _c(){return new hi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sl(),fragmentShader:`
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function vc(){return new hi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Sl(),fragmentShader:`
...
#define LOW_PRECISION`),t}function S_(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===ou?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Gh?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===On&&(t="SHADOWMAP_TYPE_VSM"),t}function M_(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case br:case Ar:t="ENVMAP_TYPE_CUBE";break;case ga:t="ENVMAP_TYPE_CUBE_UV";break}return t}function y_(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Ar:t="ENVMAP_MODE_REFRACTION";break}return t}function E_(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case lu:t="ENVMAP_BLENDING_MULTIPLY";break;case of:t="ENVMAP_BLENDING_MIX";break;case lf:t="ENVMAP_BLENDING_ADD";break}return t}function w_(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function T_(n,t,e,i){const r=n.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=S_(e),c=M_(e),u=y_(e),d=E_(e),h=w_(e),m=f_(e),g=d_(s),v=r.createProgram();let p,f,T=e.glslVersion?"#version "+e.glslVersion+`
