import{c as B,K as F,p as D}from"./index-DmgjFuaj.js";import{p as l}from"./parseSGS-B7SznWJR.js";import"./search-worker-entry-CiiqNvj2.js";let U=null;async function v(){return U??(U=e())}async function e(){return l(await B.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg F D F' D L2 F R' F' D' B2 U'`)}async function t(){const{getPuzzleGeometryByName:R,ExperimentalPGNotation:g}=await import("./index-9mpLuvhO.js"),L=R("megaminx",{allMoves:!0,addRotations:!0}),A=new F(L.getKPuzzleDefinition(!0),{experimentalPGNotation:new g(L,L.getOrbitsDef(!0))});return A.definition.name="megaminx",A}let n=null;async function a(){return n??(n=t())}let i=null;async function w(){return i??(i=r())}async function r(){return l(await a(),`SubgroupSizes 12 5 60 58 60 56 54 57 52 50 54 48 46 51 44 42 48 40 45 38 36 42 34 32 39 30 36 28 26 33 24 30 22 20 27 18 24 16 14 21 12 18 10 15 8 6 2 12 9 3
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}let u=null;async function o(){return u??(u=c())}async function h(){return{ordering:(await o()).ordering.slice(2)}}async function c(){return l(await D.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg u
Alg u'`)}async function s(){const{getPuzzleGeometryByName:R,ExperimentalPGNotation:g}=await import("./index-9mpLuvhO.js"),L=R("skewb",{allMoves:!0,addRotations:!0});return new F(L.getKPuzzleDefinition(!0),{experimentalPGNotation:new g(L,L.getOrbitsDef(!0))})}let y=null;async function z(){return y??(y=s())}let m=null;async function d(){return m??(m=p())}async function P(){return{ordering:(await d()).ordering.slice(1)}}async function p(){return l(await z(),`SubgroupSizes 24 6 5 12 9 3 4 9 3 3
...
Alg U R' U' L B R' B' R
Alg R' U' R U B' U' B L`)}export{v as cachedData222,a as cachedMegaminxKPuzzleWithoutMO,w as cachedSGSDataMegaminx,o as sgsDataPyraminx,h as sgsDataPyraminxFixedOrientation,d as sgsDataSkewb,P as sgsDataSkewbFixedCorner,z as skewbKPuzzleWithoutMOCached};
